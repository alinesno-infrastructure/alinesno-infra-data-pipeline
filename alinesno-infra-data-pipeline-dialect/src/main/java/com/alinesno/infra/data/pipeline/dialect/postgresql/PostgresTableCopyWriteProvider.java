...
import com.alinesno.infra.data.pipeline.dialect.postgresql.copy.row.SimpleRow;
import com.alinesno.infra.data.pipeline.dialect.postgresql.copy.row.SimpleRowWriter;
...
import com.alinesno.infra.data.pipeline.dialect.postgresql.copy.row.SimpleRowWriter.Table;
