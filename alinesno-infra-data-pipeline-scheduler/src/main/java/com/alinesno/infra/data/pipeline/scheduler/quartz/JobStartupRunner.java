...
//
//    public static String TRIGGER_GROUP_NAME = "test_trigger";
//    public static String JOB_GROUP_NAME = "test_job";
//
//    @Override
...
//                trigger = TriggerBuilder.newTrigger().withIdentity("trigger1", TRIGGER_GROUP_NAME).withSchedule(scheduleBuilder).build();
//
...
//
//                trigger2 = TriggerBuilder.newTrigger().withIdentity("trigger2", TRIGGER_GROUP_NAME).withSchedule(scheduleBuilder).build();
...
//            }
//
//            TriggerKey triggerKey4 = TriggerKey.triggerKey("triggerKey4", TRIGGER_GROUP_NAME);
...
//                Class<QuartzJob> clazz = QuartzJob.class;
//
//                JobDetail jobDetail3 = JobBuilder.newJob(clazz).withIdentity("job4", JOB_GROUP_NAME).usingJobData("name", "weiz QuartzJob3").build();
//                CronScheduleBuilder scheduleBuilder = CronScheduleBuilder.cronSchedule("0/1 * * * * ?");
//
//                trigger4 = TriggerBuilder.newTrigger().withIdentity("trigger4", TRIGGER_GROUP_NAME).withSchedule(scheduleBuilder).build();
//                scheduler.scheduleJob(jobDetail3, trigger4);
//
//                System.out.println("Quartz 创建了job:...:{}" + jobDetail3.getKey());
//            } else {
//                System.out.println("job已存在:{}" + trigger4.getKey());
//            }
//
//            scheduler.start();
//        } catch (Exception e) {
