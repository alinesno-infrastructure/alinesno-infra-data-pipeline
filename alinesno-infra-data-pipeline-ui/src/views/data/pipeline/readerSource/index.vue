         ...
         <el-col :span="24" :xs="24">
            <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="100px">
               <el-form-item label="描述" prop="readerName">
                  <el-input v-model="queryParams.readerName" placeholder="请输入描述" clearable style="width: 240px" @keyup.enter="handleQuery" />
               </el-form-item>
               <el-form-item label="读取源名称" prop="readerName">
                  <el-input v-model="queryParams['condition[readerName|like]']" placeholder="请输入读取源名称" clearable style="width: 240px" @keyup.enter="handleQuery" />
               </el-form-item>
               <el-form-item>
            ...
            <el-table v-loading="loading" :data="ReaderSourceList" @selection-change="handleSelectionChange">
...
function handleDelete(row) {
   ...
   proxy.$modal.confirm('是否确认删除应用编号为"' + readerDescTmp + '"的数据项？').then(function () {
      return delReaderSource(readerIds);
   }).then(() => {
      getList();
