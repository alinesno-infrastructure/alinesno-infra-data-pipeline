...
public class TransformController extends BaseController<TransformEntity, ITransformService> {

    @Autowired
    private ITransformService service;
    ...
    @Override
    public ITransformService getFeign() {
        return this.service;
    }
}
