package com.alinesno.infra.data.pipeline.logback;
  ...
  public static void addDatabaseAppender(List<String> loggerClassNames,
    ...
    try {
      LoggerContext loggerContext = (LoggerContext) LoggerFactory.getILoggerFactory();
        ...
        SiftingAppender sa = getSiftingAppender(handler, loggerContext);
        sa.start();
    ...
    @NotNull
    private static SiftingAppender getSiftingAppender(Consumer<LogbackEventContent> handler, LoggerContext loggerContext) {
