...
public class TransRunHisController extends BaseController<TransRunHisEntity, ITransRunHisService> {

    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(TransRunHisController.class);

    @Autowired
    private ITransRunHisService service;
