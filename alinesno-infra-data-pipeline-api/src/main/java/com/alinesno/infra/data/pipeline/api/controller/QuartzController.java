...
//
///**
// * 处理与定时任务相关的请求的Controller。
// * 继承自BaseController类并实现IQuartzService接口。
// *
// * @version 1.0.0
// * @author luoxiaodong
// * @since 1.0.0
...
//@RequestMapping("/api/infra/simple/crm/quartz")
//public class QuartzController extends BaseController<QuartzEntity, IQuartzService> {
//
//    // 日志记录
//    private static final Logger log = LoggerFactory.getLogger(QuartzController.class);
//
//    @Autowired
//    private IQuartzService service;
//
//    /**
//     * 获取定时任务的DataTables数据。
//     *
